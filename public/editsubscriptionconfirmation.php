...
if (!isset($_SESSION['approvedid'])) {
    ...
    {
        $mailingListValue = $_POST['mailingList'];
        \M5\classes\business\UserManager::updateSubscription($mailingListValue);
    }

if (!\M5\classes\business\UserManager::updateSubscription($mailingListValue)) {
