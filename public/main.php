...
<div class="row">
    ...
    <div class="col-lg-5" style="height:314px;border-style: solid; background-color: #FFF056; border-color: #FFF056;border-width: 5px;">
        <img class="img-responsive" style="width:100%;display:block;" src="image/homepage.png" alt="homepage">
    </div>
</div>
